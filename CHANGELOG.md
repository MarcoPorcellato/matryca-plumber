...
- **Documentation sync (nanosecond OCC #38, shutdown #44)** — [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md), [`ROADMAP.md`](ROADMAP.md), [`docs/PROJECT_DIARY.md`](docs/PROJECT_DIARY.md), [`docs/openspec/runtime-bootstrap.md`](docs/openspec/runtime-bootstrap.md), [`docs/openspec/security-sandbox.md`](docs/openspec/security-sandbox.md), [`CONTRIBUTING.md`](CONTRIBUTING.md), [`SYSTEM_PROMPT.md`](SYSTEM_PROMPT.md), [`llms.txt`](llms.txt) / [`.well-known/llms.txt`](.well-known/llms.txt), [`README.md`](README.md), and [`docs/roadmaps/ROADMAP_IRONCLAD_SHIELD.md`](docs/roadmaps/ROADMAP_IRONCLAD_SHIELD.md) aligned with `st_mtime_ns` integer OCC, `normalize_stored_mtime_ns`, and graceful shutdown `logger.exception` semantics.
