...
- **LLM-free BM25 query-result cache** — resident in-process BM25 now keeps a bounded 128-entry LRU of immutable score rows keyed by tokenized request, limit, and scoring parameters; per-corpus synchronization serializes scoring with batch graph changes before invalidation, and content-free hit/miss/invalidation counters support synthetic cold/warm measurement without adding a service or inference dependency.
