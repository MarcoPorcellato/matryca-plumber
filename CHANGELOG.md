...
- **LLM-free BM25 query-result cache** — resident in-process BM25 now keeps a bounded 128-entry LRU of immutable score rows keyed by tokenized request, limit, and scoring parameters; batch graph changes clear it before the next read, and content-free hit/miss/invalidation counters support synthetic cold/warm measurement without adding a service or inference dependency.
