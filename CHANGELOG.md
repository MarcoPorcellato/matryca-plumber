...
- **Local retrieval execution bridge (#448)** — replay caller-supplied or synthetic input evidence through an explicitly configured provider-neutral seam, retaining deterministic item, exclusion, failure, and digest-bound artifacts without downloads, inference, vault access, or network calls.
