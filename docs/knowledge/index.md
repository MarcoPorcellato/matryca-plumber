...
- [Proposed v2.0.1-rc.3 qualification plan](../quality/V2_0_1_RC3_RELEASE_QUALIFICATION_PLAN_2026-08-31.md) — Active Tier 3 preparation contract; no RC3 source, tag, workflow run, publication, artifact, Gate B result, or stable decision is selected or passed.
