...
title: Agentic Memory Leadership Programme — August 10, 2026
description: Evidence-first control-plane and benchmark programme for biological memory delivery in Matryca Plumber.
resource: docs/quality/AGENTIC_MEMORY_LEADERSHIP_PROGRAMME_2026-08-10.md
tags: [quality, roadmap, governance, memory, benchmark]
...
source_ref: main
source_commit: 013267d168a66947fb581a95ed20b98194b29edb
...
```mermaid
flowchart TB
  P0["P0: canonical recall, provenance, idempotence, invalidation, benchmark evidence"]
  P1["P1: hybrid retrieval, cache, clustering"]
  P2["P2: proposal queue, curation"]
  P3["P3: procedural memory, typed activation decay, opt-in proactivity"]
  P0 --> P1
  P1 --> P2
  P2 --> P3
```
