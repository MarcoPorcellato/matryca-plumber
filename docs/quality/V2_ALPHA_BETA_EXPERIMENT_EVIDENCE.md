...
### r4 — current installed-wheel gate
...
The 60-second page-parse deadline was an evidence-collection setting, not the product's 15-second default and not an SLA. This gate does not by itself make the beta ready.
