...
| Installed-wheel upgrade and recovery | `2.0.0a5` → `2.0.0b1` on a copied vault; compatible generation/meta preserved; schema mismatch and injected rebuild failure recover safely without partial reads or Markdown writes | [ ] |
