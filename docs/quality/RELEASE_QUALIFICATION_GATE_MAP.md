...
| --- | --- | --- | --- | --- |
| [v2.0.1-rc.4 release preparation](V2_0_1_RC4_RELEASE_PREPARATION_2026-09-06.md) | Tier 2 pending exact-candidate classification: internal OG topology runtime, Parser 1.9 dependency, and installed static contract/TCK resources | Preparation base `62e1abb6c6177c3063e0dd87c43510190fd9d24a`; #579 | `proposed` | Candidate source, tag, workflow run, public bundle, package installation/resource-byte checks, and stable decision remain unselected. DB capability discovery remains `test_only/unbound`; no DB support, transport, consumer wiring, UI, or LENS is introduced. A final risk classification and its selected qualification gates remain required before publication. |
