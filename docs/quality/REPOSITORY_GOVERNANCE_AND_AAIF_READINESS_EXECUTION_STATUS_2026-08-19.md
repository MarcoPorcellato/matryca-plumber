...
| M3 — interoperability and TCK | `in_progress` | versioned contract, corpus, deterministic result schema | qualify the documented consumer paths with operational receipts; keep external-provider and concurrent-writer claims unqualified until exact-head evidence exists |
