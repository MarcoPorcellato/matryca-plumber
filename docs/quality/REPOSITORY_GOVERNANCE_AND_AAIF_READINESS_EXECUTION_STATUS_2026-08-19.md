...
| M4 — outcome evaluation | `in_progress` | reproducible graph-outcome evidence | implement #527 as the next evidence-bound synthetic failure-injection slice, then add production-adapter scenarios; do not infer agent, release, or platform qualification |
