...
| `V2-0-1-RC2-PLAN-001` | The proposed RC2 plan selects Tier 3 qualification for operator `.env` parent-directory fsync durability and maintenance-robot Git commit-path isolation. | Future v2.0.1-rc.2 candidate; milestone #22 and issue #548 | `docs/quality/V2_0_1_RC2_RELEASE_QUALIFICATION_PLAN_2026-08-31.md`; `docs/quality/RISK_BASED_RELEASE_QUALIFICATION_DECISION_2026-08-24.md` | Preparation base `1cb4ca9ddd9d40d91e2c033ba8b816880323889a`; proposed terminal-gate matrix requires both successful-parent-fsync and future tolerated-parent-fsync-failure tests. | `proposed` | No signed squash-merge source, tag, public artifact, hosted CI result, installed-package result, parser matrix, Gate B result, release qualification, publication, or stable decision is recorded. A post-replacement parent-fsync `OSError` must be non-fatal and non-rollback, but cannot establish directory-entry durability for that attempt. RC1 evidence remains historical and non-transferable. | 2027-02-27 |
