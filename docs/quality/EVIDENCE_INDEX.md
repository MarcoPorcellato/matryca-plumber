...
| `CCP-HYBRID-CONTRACT-001` | The repository defines a pinned multi-runtime local-CI contract, opt-in trusted exact-head receipt observer, immutable savings ledger, and fail-closed operating path without changing hosted-CI authority. | Task 6 Step 0 accepted public verifier boundary | `.commit-ci-preflight.toml`; `.commit-ci-policy.toml`; `.github/workflows/receipt-gate.yml`; `docs/quality/CCP_HYBRID_CI_RUNBOOK.md` | Deterministic contract tests and plan-derived policy bindings cover three runtimes and 18 required checks, including source security; the trusted observer remains pinned to signed source `3fccc197e5055a2759ee7afe51b91133938ec904`, while the separately qualified active local coordinator is source `27adf8d0820b3cd96f9c5e149de9b580ae41f639` with executable `sha256:c8021e2322e172686c0a0c07d2b0260eafb5812d085d2306dbbde3fe4e964bd4`. Official guidance is reconciled to CCP documentation `main@6ff736b1e2a1dfde8778330efdd4b82c845d45e7`; operator targets select `current-v2` explicitly and do not expose a heavy run. Ineligible or unlabelled PRs publish no receipt status, and hosted `.github/workflows/ci.yml` remains unconditional. | `proposed` | No official matrix receipt exists. The legacy profile and single-runtime receipt-v2 policy are not accepted migrations; the newer active local coordinator does not transfer public verifier compatibility. Coordinator diagnosis, OCI architecture evidence, parity, seven negative receipt cases, routing activation, ruleset changes, and claimed savings remain blocked by their independent gates. | 2026-11-22 |
