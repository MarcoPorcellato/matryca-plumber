...
This project is indexed by GitNexus as **matryca-plumber** (9850 symbols, 22713 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
