...
This project is indexed by GitNexus as **matryca-plumber** (7791 symbols, 16941 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
